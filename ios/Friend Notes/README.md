...
|---|---|---|
| ![Friends list and relationship overview](../../screenshots/ios/screenshot_1.png) | ![Upcoming calendar entries and planning](../../screenshots/ios/screenshot_2.png) | ![Gift ideas with open and completed states](../../screenshots/ios/screenshot_3.png) |
...
2. Open the iOS project:
   ```bash
   cd friend-notes/ios/Friend\ Notes
